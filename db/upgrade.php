...
function xmldb_katest_upgrade($oldversion) {
     ...
     * for demonstrative purposes and to show how the katest
     * iself has been upgraded.
     *
     * For each upgrade block, the file katest/version.php
    ...
    if ($oldversion < 2007040100) {
        ...
        // Define field course to be added to katest.
        $table = new xmldb_table('katest');
        ...
        // Define field intro to be added to katest.
        $table = new xmldb_table('katest');
        ...
        // Define field introformat to be added to katest.
        $table = new xmldb_table('katest');
        ...
        upgrade_mod_savepoint(true, 2007040100, 'katest');
    }
    ...
    if ($oldversion < 2007040101) {
        ...
        // Define field timecreated to be added to katest.
        $table = new xmldb_table('katest');
        ...
        // Define field timemodified to be added to katest.
        $table = new xmldb_table('katest');
        ...
        // Define index course (not unique) to be added to katest.
        $table = new xmldb_table('katest');
        ...
        upgrade_mod_savepoint(true, 2007040101, 'katest');
    }
    ...
    if ($oldversion < 2007040200) {
        ...
        upgrade_mod_savepoint(true, 2007040200, 'katest');
    }
