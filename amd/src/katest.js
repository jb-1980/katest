...
define(['jquery',
        'core/ajax',
        'core/templates',
        'core/notification'], function($, ajax, templates, notification) {
    return /** @alias module:mod_katest/katest */ {
        ...
        submitTest: function(){
          $('.katest-submit-button').click(function() {
            ...
            var msg = 'Thanks for submitting your test. Your data is being';
            msg += ' collected from Khan Academy and a grade shall be issued';
            msg += 'shortly.\n'+timeString;
            alert(msg);
          });
        }
